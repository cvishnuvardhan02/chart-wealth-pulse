...
import { ChartBar, BookOpen, Brain } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 font-inter">
      ...
      >
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          >
            <TabsList className="grid grid-cols-3 bg-gray-800/50 p-1 backdrop-blur-md border border-gray-700/30 rounded-xl">
